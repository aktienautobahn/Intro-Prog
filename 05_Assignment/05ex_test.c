...
int main(int argc, char const *argv[]) {
    ...
    test_cases[0].gt_item = 3;

    test_cases[1].before_insert = t_3();
    test_cases[1].item = 3;
    test_cases[1].after_insert = t_3();
    test_cases[1].gt_item = 3;

    test_cases[2].before_insert = t_8();
    test_cases[2].item = 8;
    test_cases[2].after_insert = t_8();
    test_cases[2].gt_item = 8;

    test_cases[3].before_insert = t_3();
    test_cases[3].item = 8;
    test_cases[3].after_insert = t_3_8();
    test_cases[3].gt_item = 8;

    test_cases[4].before_insert = t_8();
    test_cases[4].item = 3;
    test_cases[4].after_insert = t_8_3();
    test_cases[4].gt_item = 8;

    test_cases[5].before_insert = t_3_6();
    test_cases[5].item = 8;
    test_cases[5].after_insert = t_3_6_8();
    test_cases[5].gt_item = 8;

    test_cases[6].before_insert = t_3_8();
    test_cases[6].item = 6;
    test_cases[6].after_insert = t_3_8_6();
    test_cases[6].gt_item = 8;

    test_cases[7].before_insert = t_6_3();
    test_cases[7].item = 8;
    test_cases[7].after_insert = t_6_3_8();
    test_cases[7].gt_item = 8;

    test_cases[8].before_insert = t_6_8();
    test_cases[8].item = 3;
    test_cases[8].after_insert = t_6_8_3();
    test_cases[8].gt_item = 6;

    test_cases[9].before_insert = t_8_3();
    test_cases[9].item = 6;
    test_cases[9].after_insert = t_8_3_6();
    test_cases[9].gt_item = 8;

    test_cases[10].before_insert = t_8_6();
    test_cases[10].item = 3;
    test_cases[10].after_insert = t_8_6_3();
    test_cases[10].gt_item = 6;

    test_cases[11].before_insert = t_6_3_8();
    test_cases[11].item = 6;
    test_cases[11].after_insert = t_6_3_8();
    test_cases[11].gt_item = 8;

    test_cases[12].before_insert = t_6_3_8();
    test_cases[12].item = 3;
    test_cases[12].after_insert = t_6_3_8();
    test_cases[12].gt_item = 6;

    test_cases[13].before_insert = t_6_3_8();
    test_cases[13].item = 8;
    test_cases[13].after_insert = t_6_3_8();
    test_cases[13].gt_item = 8;

    test_cases[14].before_insert = t_large();
    test_cases[14].item = 1;
    test_cases[14].after_insert = t_large_1();
    test_cases[14].gt_item = 2;

    test_cases[15].before_insert = t_large();
    test_cases[15].item = 2;
    test_cases[15].after_insert = t_large();
    test_cases[15].gt_item = 3;

    test_cases[16].before_insert = t_large();
    test_cases[16].item = 8;
    test_cases[16].after_insert = t_large();
    test_cases[16].gt_item = 9;

    test_cases[17].before_insert = t_large();
    test_cases[17].item = 25;
    test_cases[17].after_insert = t_large_25();
    test_cases[17].gt_item = 33;

    Tester tester = tester_new(argc - 1, argv[1], argv[2],
                               "cc -std=c11 -g -Wall -Werror "TEST_NAME".c -o "TEST_NAME".o -lm && ./"TEST_NAME".o");

    /* Aufgabe 1*/
    if(begin_exercise(&tester, "search_tree_insert", "Aufgabe 1: Einfügen in einen Ordere-Statistic Search Tree."))
    {
        for(int i = 1 /* skip the test case with an empty input tree */; i < TEST_CASES; i++)
        {
            if(begin_testcase(&tester))
            {
                ...
                bool got_changed = search_tree_insert(got, test_cases[i].item);
                assert_ost(&tester, test_cases[i].after_insert, got, args);
                assert_bool(&tester, !search_tree_eq(test_cases[i].before_insert, test_cases[i].after_insert), got_changed, args);
                free(args);
    ...
    /* Aufgabe 2*/
    if(begin_exercise(&tester, "search_tree_get_greater_than", "Aufgabe 2: Suchen von nächstgrößerem Element."))
    {
        for(int i = 0; i < TEST_CASES; i++)
        {
            if(begin_testcase(&tester))
            {
                ...
                uint16_t got = search_tree_get_greater_than(test_cases[i].before_insert, test_cases[i].item);
                assert_int(&tester, test_cases[i].gt_item, got, args);
                free(args);
            }
        }
    }
